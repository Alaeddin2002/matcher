...
def main():
    ...
    parser.add_argument('-t', '--threshold', type=float, default=0.5, help='Threshold for predicting a match')
    ...
    for comparison in iterator:
        ...
        logging.info(f"Got the Results")
    ...
    logging.info(f"Finished scoring {len(results)} results")
